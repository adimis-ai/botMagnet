    ...
    <section className="bg-gray-50 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full flex justify-center mt-[8px]">
          <a
            href="https://www.producthunt.com/posts/botmagnet?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-botmagnet"
            target="_blank"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=400035&theme=dark"
              alt="botmagnet - Illuminating&#0032;paths&#0032;to&#0032;effortless&#0032;documentation&#0032;experiences | Product Hunt"
